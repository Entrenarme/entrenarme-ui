...
storiesOf('Text/Headers/H5', module).add(
  'default',
  withInfo('Heading 5')(() => (
    <div>
      <H5>Heading 5</H5>
      <P>
        ...
        eros sagittis eget. Phasellus eleifend risus et arcu laoreet, vitae
        lobortis turpis feugiat. Maecenas pulvinar ultricies risus nec
        tincidunt. Donec tristique imperdiet dui at egestas. Praesent ornare et
        ante sit amet condimentum.
      </P>
    </div>
  )),
);
